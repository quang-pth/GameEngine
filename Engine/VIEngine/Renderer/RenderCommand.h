...
namespace VIEngine {
	...
	public:
		...
		static void DrawArrays(uint32_t nums, ERendererPrimitive primitive = ERendererPrimitive::Triangles, uint32_t offset = 0) { sInstance->DrawArraysImpl(nums, primitive, offset); }
	...
	protected:
		...
		virtual void DrawArraysImpl(uint32_t nums, ERendererPrimitive primitive, uint32_t offset) = 0;
	...
	protected:
		...
		virtual void DrawArraysImpl(uint32_t nums, ERendererPrimitive primitive, uint32_t offset) override;
